...
namespace WindowsFormsApplication4.DataSet3TableAdapters {
...
SELECT [Номер зачетки], [Номер предмета] FROM [Table] WHERE ([Номер зачетки] = @Номер_зачетки)";
        ...
        public virtual int Fill(DataSet3.TableDataTable dataTable) {
        ...
        public virtual DataSet3.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet3.TableDataTable dataTable = new DataSet3.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet3.TableDataTable dataTable) {
...
SELECT [Номер предмета], [Название предмета] FROM Предметы WHERE ([Номер предмета] = @Номер_предмета)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet3.ПредметыDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet3.ПредметыDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet3.ПредметыDataTable dataTable = new DataSet3.ПредметыDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet3.ПредметыDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
